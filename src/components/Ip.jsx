    ...
    <label htmlFor='ip' className='cursor-pointer'>
      <div className='bg-box p-5 flex flex-col text-white rounded-xl '>
        <div className='flex justify-between mb-5'>
          <div className='flex flex-col bg-ip-box rounded-xl'>
        ...
        <p className='font-semibold border-b border-white pb-3 mb-5'>Ip Addressess</p>
        <div className='flex items-center justify-between border-b mb-5 border-white pb-5'>
          <div className='flex items-center gap-3'>
            <div className='flex flex-col items-center gap-1'>
              <span className='font-bold'>Live</span>
              <span className='font-bold text-2xl'>{ipInfo?.total_live}</span>
            </div>
            <div>
              <Chart chartInfo={ipInfo?.live}/>
            </div>
          </div>
          <div className='flex items-center gap-3'>
            <div className='flex flex-col items-center gap-1'>
              <span className='font-bold'>Monitored</span>
              <span className='font-bold text-2xl'>{ipInfo?.total_monitored}</span>
            </div>
            <div>
            <Chart chartInfo={ipInfo?.monitored}/>
            </div>
          </div>
        </div>
        <div className='flex items-center justify-between'>
          <div className='flex items-center gap-2'>
            ...
            <div className='flex flex-col'>
              ...
              <span className='font-bold text-lg'>{ipInfo?.ips}</span>
            </div>
          </div>
          <div className='flex items-center gap-2'>
            <div className='w-12 h-12 bg-box-little rounded-xl flex items-center justify-center'>
            ...
            <div className='flex flex-col'>
              ...
              <span className='font-bold text-lg'>{ipInfo?.ports}</span>
            </div>
          </div>
          <div className='flex items-center gap-2'>
            <div className='w-12 h-12 bg-box-little rounded-xl flex items-center justify-center'>
            ...
            <div className='flex flex-col'>
              ...
              <span className='font-bold text-lg'>{ipInfo?.vulns}</span>
            </div>
          </div>
        </div>
      </div>
      <input name='netbaan' type='radio' id='ip' value='ip' onChange={handleChange} className='hidden' />
    </label>
  )
}
